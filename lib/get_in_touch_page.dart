...
class _GetInTouchPageState extends State<GetInTouchPage> {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: color.secondary, width: 1.0),
          borderRadius: BorderRadius.circular(18),
        ),
        hintText: hint,
  ...
  Widget buildSubmitButton() {
    return MaterialButton(
      ...
      onPressed: submit,
      color: isSubmitting ? Colors.grey : color.secondary,
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: Row(
            ...
            children: <Widget>[
              SizedBox(
                width: 256,
                child: buildContactItem(Icons.call, "Phone", data.phone),
              ),
              Expanded(
        ...
        Row(
          ...
          children: <Widget>[
            SizedBox(
              width: 256,
              child: buildContactItem(Icons.my_location, "Location", data.location),
            ),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget buildPhoneLayout() {
    ...
    return Column(
      ...
      children: <Widget>[
        buildContactItem(Icons.call, "Phone", data.phone),
        space,
            ...
            children: <Widget>[
              ...
              LayoutBuilder(
                builder: (_, constrain) {
                  ...
                  return maxWidth >= widthForTablet ? buildTabletLayout() : buildPhoneLayout();
                },
              ),
              SizedBox(height: 32),
              Text(
